...
if(isset($_POST['reset'])){
    if($pass===$cpass){
        $sql = "UPDATE people SET user_pass = '$pass' WHERE user_email='$email'";
  ...
  <div class="login-box-body">
    ...
    <form action="<?php htmlentities($_SERVER['PHP_SELF']);?>" method="post" name="loginForm">
      <div class="form-group has-feedback">
        <input type="password" class="form-control sty1" placeholder="Password" name="pwd" pattern="(?=.*\d)(?=.*[A-Z])(?=.*[a-z]).{8,}" title="password must contain atleast 1 digit, atleast 1 uppercase letter, atleast 1 lowercase letter and minimum of 8 characters in all" title="Password is required" required><span class="note"><small>atleast 1 digit, atleast 1 uppercase letter, atleast 1 lowercase letter and minimum of 8 characters in all</small></span>
      ...
      <div class="form-group has-feedback">
        ...
        <br>
        <span class="text-danger"><?= $cpasses;?></span>
