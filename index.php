...
<body>
    ...
    <!-- preloader Start -->
    <div id="preloader">
        <div id="status"><img src="images/banner/loader.gif" id="preloader_image" alt="loader"></div>
    </div>
    ...
    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-6">
        ...
        <ul>
            ...
            <li><a href="2">Transactions</a></li>
            <li><a href="3">Yield</a></li>
            <li><a href="4">Wallet</a></li>
            <li><a href="5">Audit</a></li>
            <li><a href="6">Finance</a></li>
            <li><a href="7">Developers</a></li>
        </ul>
    </nav>
    <div class="language">
    ...
    <div class="login-btn">
        <a href="backpage/login.php" class="btn1"><i class="fa fa-user"></i><span>GET STARTED</span></a></div>
    </div>
    ...
    <div id="sidebar">
        <h1><a href="#">The Earthminers Platform</a></h1>
    ...
    <h2 data-animation="animated bounceInLeft">Earth's Digital Mine - <br>Hardware and Software Retail</h2>
    <div class="buttons">
        <a href="./backpage/login.php" class="btn1" data-animation="animated bounceInUp">GET STARTED</a>
        <a href="#" class="btn2" data-animation="animated bounceInUp">SMART CONTRACT CHECK</a>
    </div>
    </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hidden-xs hidden-sm">
        <div class="btc_timer_section_wrapper">
            <div id="clockdiv">
                <div>
                    <span class="second"><i class="fa fa-check" style="color:forestgreen !important;"></i></span>
                    <div class="smalltext"><strong>MINE</strong></div>
                </div>
            <div>
        <span class="second"><i class="fa fa-check" style="color:forestgreen !important;"></i></span>
        <div class="smalltext"><strong>TRANSACT</strong></div>
        </div>
        <div>
        <span class="second"><i class="fa fa-check" style="color:forestgreen !important;"></i></span>
        <div class="smalltext"><strong>CREDIT</strong></div>
        </div>
        <div>
        <span class="second"><i class="fa fa-check" style="color:forestgreen !important;"></i></span>
        <div class="smalltext"><strong>EXCHANGE</strong></div>
                                </div>
        <div>
        <span class="second"><i class="fa fa-check" style="color:forestgreen !important;"></i></span>
        <div class="smalltext"><strong>P2P-ESCROW</strong></div>
                                </div>
        <div>
        <span class="second"><i class="fa fa-check" style="color:forestgreen !important;"></i></span>
        <div class="smalltext"><strong>WALLET</strong></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="item">
        ...
        <h2 data-animation="animated bounceInLeft"> Earthminers - <br>Lending and Digital Solutions For People and Businesses</h2>
        <div class="buttons">
            <a href="#" class="btn1" data-animation="animated bounceInUp">WALLET</a>
            <a href="#" class="btn2" data-animation="animated bounceInUp">SMART CONTRACTS CHECKER</a>
        </div>
    </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12  hidden-xs hidden-sm">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h2 class="f-40 fw-400 wow fadeInUp animated text-center text-dark"data-wow-duration="1.0s" style="visibility:visible; animation-duration: 1.0s; animation-name: fadeInUp;">Monthly Net Transactions<br>
        <span class="lead text-white"> We are all strong believers in the future of digital currencies and we love being part of the growing  Earthminers' community.</span></h2>
    ...
    <div class="btn3">2.3498775 BTC</div>
    </div>
    </div>
    </div>
    ...
    <button class="btn3">14.98765768 ETH</button>
    </div>
    </div>
    </div>
    ...
    <div class="content">
    <div class="con">
    <h2><img src="images/icons/3.png" alt=""><span>Binance Coin</span></h2>
    <button class="btn3">58634.000 BNB</button>
    </div>
    </div>
    </div>
    ...
    <div class="content">
    <div class="con">
    <h2><img src="images/icons/4.png" alt=""><span>Tether</span></h2>
    <button class="btn3">111969.062 USDT</button>
    </div>
    </div>
    </div>
    ...
    <div class="content">
    <div class="con">
    <h2><img src="images/icons/5.png" alt=""><span>Dollars USD</span></h2>
    <button class="btn3">346636.775 USD</button>
    </div>
    </div>
    </div>
    </div>
    ...
    <h2 class="f-40 fw-400 wow  fadeInUp animated text-dark" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">About The Project</h2>
    <p class="wow  fadeInUp animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">Earthminers is a technology based outfit for information, events, web based services, IT development, telecoms and other related utilities and technology. <br>Our story goes back to 2019. Our founders knew each other via a platform they both used for buying and selling altcoins. They were fascinated by their interest in the technology deployed by the platform and wanted to build their own which gave birth to the <span class="lead">Earthminers' platform</span>.</p>
    <p class="wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">Earthminers is a network of people who have come together to build a one-stop platform for the minting and harvesting of crypto and digital products. The platform built is <span class="lead">The Earthmine</span>, which is a multi-functional platform which allows each participant to mint, keep and transfer money in a multi-currency online wallet; buy and sell currency on the exchange; invest money; get a loan in a convenient currency.</p>
    <p class="wow  fadeInUp animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">There are investors and borrowers who also converge on the Earthminers platform. They meet each other and have the opportunity to lend money and transact on a mutually beneficial basis, making <span>Earthminers</span>a unique service that allows individuals to access loans from the comfort of their home in fiat and crypto-currencies.</p>
    <div class="buttons">
    <a href="#" class="btn1">LEARN MORE</a>
    <a href="#" class="btn3">DOCS!</a>
    </div>
    </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    ...
    <img src="images/about/1.png" alt="earthminers" title="The Earthminers platform" />
    </div>
    </div>
    </div>
    </div>
    ...
    <h2>Powered by the Blockchain and Smart Contracts</h2>
    <span class="lead">Earthminers makes it possible to create, send, and trade digital features in all forms of money: Dollars, Euros, Bitcoin, Ethereum and pretty much anything else. It’s designed so all the world’s investment demands can be fully met on a single hub.</span>
    </div>
    </div>
    </div>
    <div class="row">
    ...
    <h2>Earthmine</h2>
    <p>Keep your money, exchange your money, invest your money,<br> pay services and make purchases.</p>
    ...
    <div class="imgs-l">
    <figure><img src="images/features/3.png" alt="Earthminers Featured Image" title="Earthminers&nbsp;&trade; Featured Image" /></figure>
    </div>
    </div>
    ...
    <h2>Exchange and P2P</h2>
    <p>Exchange between popular currencies with a few clicks.
    ...
    <div class="imgs-r">
    <figure><img src="images/features/2.png" alt="Earthminers Featured Image" title="Earthminers&nbsp;&trade; Exchange and P2P" /></figure>
    </div>
    </div>
    ...
    <div class="contents-l mr-b30">
    <h2>Staking and Investments</h2>
    <p>Unique platform for staking, yield farming and investments with a safety fund<br>and cooperation with world-wide arbitration.</p>
    <a href="#" class="btn1">read more</a>
    </div>
    </div>
    ...
    <div class="imgs-r">
    <figure><img src="images/features/1.png" alt="Earthminers Featured Image" title="Earthminers&nbsp;&trade; Staking, Yield Farming and Investments Program" /></figure>
    </div>
    </div>
    ...
    <div class="contents-r">
    <h2>Lending and Verification</h2>
    <p>Improved system of lending and borrower verification. Providing
    ...
    <div class="imgs-l">
    <figure><img src="images/features/3.png" alt="Earthminers Featured Image" title="Earthminers&nbsp;&trade; Lending and Verification Solution" /></figure>
    </div>
    </div>
    ...
    <div class="col-sm-6 pd-0 wow  fadeInUp animated" data-wow-duration="2.1s" style="visibility: visible; animation-duration: 2.1s; animation-name: fadeInUp;">
    <div class="imgs-r">
    <figure><img src="images/features/4.png" alt="Earthminers Featured Image" title="Earthminers&nbsp;&trade; Online, Desktop and Mobile Wallet" /></figure>
    </div>
    </div>
    <div class="col-sm-6 pd-0 floatright mr-b30 visible-xs wow  fadeInUp animated" data-wow-duration="2.1s" style="visibility: visible; animation-duration: 2.1s; animation-name: fadeInUp;">
    <div class="contents-r">
    ...
    <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">Multiple Utility System</h2>
    </div>
    </div>
    </div>
    <div class="row">
    ...
    <div class="content">
    <span class="icons"><img src="images/icons/10.png" alt="Earthminers Featured Image" title="Earthminers - Secure Minting and Farming" /></span>
    <h3>Secure Mine <br>and Farm</h3>
    </div>
    </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
    ...
    <div class="content">
    <span class="icons"><img src="images/icons/7.png" alt="Earthminers Featured Image" title="Earthminers - Advanced Security System" /></span>
    ...
    <div class="content">
    <span class="icons"><img src="images/icons/8.png" alt="Earthminers Featured Image" title="Earthminers - Multiple Currencies" /></span>
    <h3>Multiple<br>Currencies</h3>
    </div>
    </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
    ...
    <div class="content">
    <span class="icons"><img src="images/icons/9.png" alt="Earthminers Featured Image" title="Earthminers - Exchange and P2P" /></span>
    <h3>Smart Contracts<br>Checker and Audit</h3>
    </div>
    </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
    ...
    <div class="content">
    <span class="icons"><img src="images/icons/6.png" alt="Earthminers Featured Image" title="Earthminers - Advanced Blockchain System" /></span>
    <h3>Advanced Blockchain <br>System</h3>
    </div>
    </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
    ...
    <div class="content">
    <span class="icons"><img src="images/icons/wallet_earthminers.png" alt="Earthminers Featured Image" title="Earthminers - Wallet and Storage" width="95px" height="95px" /></span>
    <h3>Wallets <br>and Storage</h3>
    </div>
    </div>
    </div>
    </div>
         ...
         <div class="row">
          <div class="col-lg-11 col-md-11 col-sm-12 col-xs-12">
           <div class="steps-heading">
            <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">The Easy Ride&reg;</h2>
    ...
    <h2>01. Simple Registration System</h2>
    <p>A simple registration opens up opportunities to:
    <br>Futures, Yield farms, Staking Pools, Crypto-backed investments, Loans, Exchange, Wallet and more at the member area.</p>
    </div>
    ...
    <h2>02. Verification</h2>
    <p>A solid verification system is currently being perfected for:
    <br>security and to boost investor and player confidence. </p>
    </div>
    ...
    <h2>03. Blockchain Assets</h2>
    <p>Invest in and own Blockchain based assets:
    <br>Cryptocurrencies, NFT's, Utilities and Stablecoins.</p>
    </div>
    ...
    <h2>04. Smart contracts</h2>
    <p> Participate in Provably Fair Programs, Yield farms, Staking Pools:
    <br>and other smart contract programs currently being developed. </p>
    </div>
    ...
    <h2>05. Financing a Loan</h2>
    <p>Available P2P backed loans are for active members to:
    <br>apply and manage via their backoffice. </p>
    </div>
    ...
    <h2>06. Wallet and Exchange</h2>
    <p>Connect with the inbuilt exchange and P2P system to trade/swap your assets:
    <br>The <em class="lead">Earthminers wallet</em>&trade; helps you control your spendings. </p>
    </div>
    ...
    <ul>
    <li>
    <span class="years"><span class="con">Rates</span></span>
    <div class="serials">
    <span class="cre"></span>
    ...
    <!-- Crypto Converter ⚡ Widget -->
        <crypto-converter-widget shadow symbol live background-color="#383a59" border-radius="0.60rem" fiat="united-states-dollar" crypto="bitcoin" amount="1" decimal-places="2"></crypto-converter-widget><a href="https://currencyrate.today/" target="_blank" rel="noopener">CurrencyRate.Today</a>
        <!-- /Crypto Converter ⚡ Widget -->
    </div>
    </div>
    </div>
    ...
    <div class="content">
    <!-- <h3>Ethereum</h3> -->
    <p><crypto-converter-widget shadow symbol live background-color="#383a59" border-radius="0.60rem" fiat="united-states-dollar" crypto="ethereum" amount="1" decimal-places="2"></crypto-converter-widget><a href="https://currencyrate.today/" target="_blank" rel="noopener">CurrencyRate.Today</a></p>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="content">
    <!-- <h3>Binance Coin</h3> -->
    <crypto-converter-widget shadow symbol live background-color="#383a59" border-radius="0.60rem" fiat="united-states-dollar" crypto="binance-coin" amount="1" decimal-places="2"></crypto-converter-widget><a href="https://currencyrate.today/" target="_blank" rel="noopener">CurrencyRate.Today</a>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="content">
    <!-- <h3>USD Tether</h3> -->
    <crypto-converter-widget shadow symbol live background-color="#383a59" border-radius="0.60rem" fiat="united-states-dollar" crypto="tether" amount="1" decimal-places="2"></crypto-converter-widget><a href="https://currencyrate.today/" target="_blank" rel="noopener">CurrencyRate.Today</a>
    </div>
    </div>
    </div>
    </div>
    ...
    <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">Bitcoin Calculator</h2>
    </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
    <p class="token-con wow  fadeInUp animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;"><span class="lead fs-40 fw-400">Our Advanced Blockchain Technology</span><br>Small and Large enterprise companies and single-dev startups have chosen our blockchain-powered solution to move money and access new markets. </p>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="section-heading">
    <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">Yield Distribution</h2>
    </div>
    </div>
    ...
    <div class="imgs"><img src="images/icons/l.png" alt="yield distribution" title="Yield Distribution Plan" /></div>
    </div>
    <div class="col-sm-6">
        <span class=""><strong>Pools</strong> inclusive of 100% deposits</span>
    <div class="label-chatrs">
    <div class="lsits">
    <span class="clabels-text">85%</span>
    <p>For participants of farms and pools</p>
    </div>
    <div class="lsits">
    <span class="clabels-text">8%</span>
    <p>Incentive for re-entry into pool</p>
    </div>
    <div class="lsits">
    <span class="clabels-text">4%</span>
    <p>Blockchain TX levies</p>
    </div>
    <div class="lsits">
    ...
    <div class="cart-list">
        <span class=""><strong>Debt Instruments</strong> inclusive of 100% investment</span>
    <div class="chart col-sm-6">
    ...
    <div class="label-chatrs">
    <div class="lsits">
    <span class="clabels-text">42%</span>
    <p>For Investors in debt instrument</p>
    </div>
    <div class="lsits">
    <span class="clabels-text">34%</span>
    <p>Incentive for re-entry</p>
    </div>
    <div class="lsits">
    <span class="clabels-text">19%</span>
    <p>Re-finance strategy</p>
    </div>
    <div class="lsits">
    <span class="clabels-text">5%</span>
    <p>Blockchain TX levies and taxes</p>
    </div>
    </div>
    </div>
    </div>
    ...
    <h2 class="wow  fadeInUp animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">The profits yield distribution are planned in the manner displayed:</h2>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="section-heading2">
    <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">Smart Contracts Checker and Audits</h2>
    </div>
    </div>
    </div>
    <div class="row">
    ...
    <div class="dbox">
    <div class="dleft">
    <img src="images/miner/crypto_smartContract.png" alt="Smart contracts checker" title="Check any smart contract" />
    </div>
    <div class="dright">
    <div class="content">
    <h3>Check any Smart Contract Now!</h3>
    <span>most blockchains</span>
    <ul>
    ...
    <div class="con">
    <p>Be sure of where your time and money is going. Check any smart contracts with our tough smarts contract checker; pick out any red lines before you invest or recommend that blockchain asset.</p>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="dbox">
    <div class="dleft">
    <img src="images/miner/crypto_smartContract.png" alt="Smart contracts auditor" title="Audit any smart contracts" />
    </div>
    <div class="dright">
    <div class="content">
    <h3>Audit Your Smart Contracts</h3>
    ...
    <div class="con">
    <p>Employ us as your smart contracts auditor. <br>We are meticulous in preparing and verifying your smart contract and our report is fillable with exchanges and related systems.</p>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="section-heading2">
    <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">Smart contracts and API</h2>
    </div>
    </div>
    </div>
    <div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="section-heading">
    <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">Implemented Technology(more at the backoffice)</h2>
    </div>
    </div>
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
    ...
    <a href="#"><img src="images/media/dark/1.png" alt="bitcoin" title="Bitcoin" /></a>
    </li>
    ...
    <a href="#"><img src="images/media/dark/2.png" alt="Dogecoin" title="Dogecoin" /></a>
    </li>
    ...
    <a href="#"><img src="images/media/dark/3.png" alt="Litecoin" title="Litecoin" /></a>
    </li>
    ...
    <a href="#"><img src="images/media/dark/4.png" alt="Z cash" title="Z cash" /></a>
    </li>
    ...
    <a href="#"><img src="images/media/dark/5.png" alt="Monero" title="Monero" /></a>
    </li>
    ...
    <a href="#"><img src="images/media/dark/6.png" alt="Ripple" title="Ripple" /></a>
    </li>
    <li class="wow  fadeInUp animated" data-wow-duration="2.7s" style="visibility: visible; animation-duration: 2.7s; animation-name: fadeInUp;">
    <a href="#"><img src="images/media/dark/7.png" alt="Ethereum" title="Ethereum" /></a>
    </li>
    <li class="wow  fadeInUp animated" data-wow-duration="2.7s" style="visibility: visible; animation-duration: 2.7s; animation-name: fadeInUp;">
    <a href="#"><img src="images/media/dark/8.png" alt="NEM" title="NEM" /></a>
    </li>
    </ul>
    </div>
    </div>
